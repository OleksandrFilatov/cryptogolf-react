...
import { Col, Container, Row, InputGroup, FormControl, Button, Overlay, Tooltip, Dropdown } from "react-bootstrap";
                                        ...
                                        ownerTokens.length > 0 ? (
                                            <Row>
                                                {ownerTokens.map((data, index) => (
                                                    <Col lg="2" xs="6" key={index} className="my-1">
                                            ...
                                            walletAddress !== null && (
                                                <Row>
                                                    <Col className="color-grey font-small bold d-flex align-items-center justify-content-center" style={{ minHeight: '200px' }}>
                                                        No NFTs
                                                    </Col>
                                                </Row>
                                            )
